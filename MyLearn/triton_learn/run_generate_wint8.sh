...
triton_repo_directory="/tyk/triton"
if [ ! -d "$triton_repo_directory" ]; then
    echo "triton_repo_directory does not exist. will clone..."
...
compile_file=/tyk/triton/python/triton/tools/compile.py
link_file=/tyk/triton/python/triton/tools/link.py

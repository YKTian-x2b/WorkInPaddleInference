...
beforeLoop = nvtx.start_range(message="beforeLoop", color="blue")
heads = 32
kv_head = heads
head_dim = 128
max_seq_len = 10240 # 1024 # 2560  # 10240     # * 10
max_batch = 1   # 2
dtype = "float16"
...
# 一共要解码decoder_len次哦！
decoder_len = 10220 # 1022    # 2050  # 10220     # * 10
...
for i in range(decoder_len):
    ...
    seq_len = paddle.max(seq_lens, axis=0).cpu()
...
nvtx.end_range(beforeLoop)

loop = nvtx.start_range(message="loop", color="blue", domain='loopDomain')
...
# print("The whole time : ", time_ms, "ms")
...
print(paddle.max(paddle.abs(my_all_out - your_all_out)))
